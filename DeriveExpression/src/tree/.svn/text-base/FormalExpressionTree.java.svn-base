...
/**
 * Un "FormalExpressionTree" est un arbre permettant de mémoriser et de
 ...
 * l'arbre associé. Cette chaîne est supposée correspondre à une expression
 * analytique syntaxiquement correcte et complètement parenthésée. Une gestion
 * d'exceptions doit être prévue lorsque cette précondition n'est pas vérifiée.
 * 
...
public interface FormalExpressionTree {
	 ...
	 * 
	 * @pre this représente une expression analytique syntaxiquement correcte.
	 * @post Une référence à un nouvel arbre représentant la dérivée formelle de
	 *       this est renvoyée.
	 */
